document.addEventListener("DOMContentLoaded", () => {
    ...
    function applyCurrentPuzzleImage() {
        ...
        /* Resolve against the HTML document: url() in var(--puzzle-image) is resolved from styles.css otherwise → css/img/ 404 */
        let resolved = new URL(currentImageUrl, window.location.href).href;
        document.documentElement.style.setProperty("--puzzle-image", `url("${resolved}")`);
    }
